...
无需切换应用，**Pi、Claude Code、OpenCode、OMP、Grok Build、DeepSeek Harness、CodeBuddy CLI 和 Antigravity CLI** 都可以在同一个 Codex Desktop 窗口中直接使用。
