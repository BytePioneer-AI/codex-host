...
No app switching required: use Pi, Claude Code, OMP, Grok Build, DeepSeek Harness, and CodeBuddy CLI directly in the same Codex Desktop window.
...
| Permission modes | Native | — | ✅ | ✅ | ✅ | ✅ | ✅ (at Session creation) |
