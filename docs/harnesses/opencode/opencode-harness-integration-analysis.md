...
> 下文 DeepSeek Host API 对比保留调研时的历史基线；当前 DSH Legacy 已移除，仅支持 `0.1.2-rc.1` / `0.1.5-rc.1` / `0.1.5-rc.2` 托管 Web，现行范围见[连接流程](../../architecture/harness-executable-discovery.md#deepseek-harness-的特殊性)和[消息修订与恢复](../deepseek/dsh-edit-recovery.md)。
