...
> 本文 Legacy 源码路径、DSH `0.1.1-rc.2` 环境与验证结果保留问题调查时的历史事实；当前 Legacy 已移除，仅支持 `0.1.2-rc.1` / `0.1.5-rc.1` / `0.1.5-rc.2`，见[消息修订与恢复](../harnesses/deepseek/dsh-edit-recovery.md)。本次版本对接不代表下述净 diff 方案已实施。
