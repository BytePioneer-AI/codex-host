...
- 仅为本机、CH-owned、exact `dsh-v0.1.2-rc.1` Modern Adapter 增加既有 Session 候选读取；Legacy `0.1.1-rc.2` 和其他 Harness 不获得导入能力。
...
- `shared-runtime-contracts`: 增加两个严格、浏览器安全且 method-specific 的 DSH Modern 导入契约。
