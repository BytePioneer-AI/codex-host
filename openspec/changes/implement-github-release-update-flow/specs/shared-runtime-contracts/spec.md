...
Shared Contracts SHALL export strict Runtime Schemas for empty update check, start, and status params and their bounded results. Results MAY contain SemVer versions, update availability and installation availability, a bounded plain-text GitHub Release body, a trusted GitHub Release HTTPS URL, normalized update installation and phase, timestamps, and bounded user-facing errors. They MUST NOT contain or accept artifact URLs, digests, local paths, process IDs, commands, package-manager locations, Controller credentials, arbitrary methods, or undeclared fields.
