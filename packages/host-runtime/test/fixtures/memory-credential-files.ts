import type { CredentialFileAccess } from "../../src/account/codex-credential-files.js";
...
export class MemoryCredentialFiles implements CredentialFileAccess {
  ...
  async lock(): Promise<NativePrivateFileLease> {
