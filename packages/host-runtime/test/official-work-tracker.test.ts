...
describe("official work beyond RPC completion", () => {
  it("tracks connection-scoped process handles and keeps a live handle on duplicate failure", () => {
    ...
    tracker.notification("a", { method: "process/exited", params: { processHandle: "same" } });
