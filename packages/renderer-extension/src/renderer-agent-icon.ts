...
// Qwen Code mark from Simple Icons (CC0), native 24x24, rendered in the
// Simple Icons brand purple #6950EF.
const QWEN_CODE_PATH =
...
export function createRendererAgentIcon(
  ...
  if (agent === "qwen-code") {
    return createSvgIcon([{ d: QWEN_CODE_PATH }], "#6950EF", size, ownerDocument);
  }
