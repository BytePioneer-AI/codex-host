...
const QWEN_PATHS = [
  {
    d: "M12 2a10 10 0 1 0 6.71 17.41l3.29 3.3-1.41 1.41-3.3-3.29A10 10 0 0 0 12 2Zm0 2a8 8 0 1 1 0 16 8 8 0 0 1 0-16Z",
  },
] as const;
...
export function createRendererAgentIcon(
  ...
  if (agent === "qwen-code") return createSvgIcon(QWEN_PATHS, "#5a67d8", size, ownerDocument);
  if (agent === "opencode") {
    const image = ownerDocument.createElement("img");
