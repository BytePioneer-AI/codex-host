...
import { installRendererLocalMediaPlayback } from "./renderer-local-media.js";
...
export function installRendererBindingProbe(
  ...
  const localMediaPlayback = installRendererLocalMediaPlayback(document);
