...
const expectedTargets = ["macos-arm64", "macos-x64", "windows-x64", "windows-arm64"];

describe("release targets", () => {
  it("defines the complete four-target matrix", () => {
  ...
  it("rejects unknown and cross-operating-system targets", () => {
    expect(() => releaseTarget("linux-x64")).toThrow("expected one of");
